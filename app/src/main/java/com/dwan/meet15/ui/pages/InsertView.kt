...
import com.dwan.meet15.ui.viewmodel.FormErrorState
import com.dwan.meet15.ui.viewmodel.FormState
import com.dwan.meet15.ui.viewmodel.InsertUiState
import com.dwan.meet15.ui.viewmodel.InsertViewModel
import com.dwan.meet15.ui.viewmodel.MahasiswaEvent
...
fun FormMahasiswa(
    ...
    Column(
        ...
        Text(
            text = errorState.judul ?: "", color = Color.Red
        )
        OutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
            ...
            placeholder = { Text("Masukkan Nama Dosbim 1") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        // Pesan error untuk Dosbim
        Text(
            text = errorState.dosbim1 ?: "", color = Color.Red
        )
        OutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
            ...
            placeholder = { Text("Masukkan Nama Dosbim 2") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        // Pesan error untuk Dosbim 2
        Text(
            text = errorState.dosbim2 ?: "", color = Color.Red
        )
    }
}